...
- applicable customer agreements; and
- applicable university export-control, research-security, information-security, and sponsored-research policies.

## 2. Export-Control Regulatory Boundary

United States export-control laws may apply to certain commodities, software, technology, technical data, defense articles, defense services, destinations, end users, and end uses.
...
- technical data related to defense articles on the United States Munitions List;
- classified information;
- Controlled Unclassified Information requiring specialized government or contractual safeguards;
- export-controlled technology requiring restricted access or licensing;
- export-controlled software requiring restricted access or licensing;
...
- controlled test or performance data;
...
- whether an item, technology, software, or technical data is subject to export controls;
- whether the EAR or ITAR applies;
- the applicable Export Control Classification Number or other classification;
- whether an item is designated EAR99;
- whether information relates to a defense article or defense service;
- whether a license is required;
- whether an exception or exemption applies;
- whether a particular destination is restricted;
- whether a particular end user is restricted;
...
University research is not automatically export-controlled merely because it involves advanced science, engineering, technology, or international collaboration.

Under applicable export-control rules, certain technology or software arising during or resulting from fundamental research and intended to be published may fall outside the scope of the EAR.

However, users must not assume that all university research qualifies as fundamental research.
...
- sponsor-imposed dissemination controls;
- restrictions on participation by foreign persons;
- government access or dissemination controls;
- restrictions accepted under a research agreement;
- the nature of technology or software supplied to conduct the research;
- controlled physical items used in the research; and
- other applicable regulatory requirements.

The fundamental-research treatment applicable to research results does not necessarily mean that all equipment, source materials, technology, software, technical data, or other information used during the research is unrestricted.

The customer's institution is responsible for determining whether the fundamental-research treatment applies.

## 6. Published and Publicly Available Information

Certain published or publicly available information may be outside the scope of particular export-control restrictions.

Users must not assume that information is unrestricted merely because:

- it has been shared with multiple researchers;
- it is available within a university;
- it has been presented internally;
- it is expected to be published later;
- a manuscript has been drafted;
- the information is stored in an academic repository;
...
The applicability of ITAR depends on the information and circumstances, not merely on whether the research is being conducted at a university.

Where a project has any connection to:
...
- technology or software classified under the Commerce Control List;
- controlled encryption technology or software;
- advanced semiconductor technology;
- aerospace or propulsion technology;
- nuclear-related technology;
- chemical or biological technology subject to export controls;
- advanced materials;
- sensors;
- navigation systems;
- robotics;
...
- other technology subject to export-control restrictions.

The presence of a technical subject area does not, by itself, establish that information is controlled.

The customer must determine the applicable classification and restrictions.

## 9. Foreign-Person Access and Deemed Exports
...
- ITAR-compliant;
- restricted to U.S.-person personnel;
- restricted exclusively to United States infrastructure;
- approved for export-controlled technical data;
...
Export-control requirements may depend on:
...
- identifying applicable classifications;
- identifying applicable licenses, exceptions, exemptions, or authorizations;
- evaluating foreign-person access restrictions;
- evaluating destination restrictions;
- evaluating end-user restrictions;
- evaluating end-use restrictions;
- complying with Technology Control Plans;
...
- ITAR certified;
- EAR certified;
- export-control certified;
- approved for ITAR technical data;
- approved for export-controlled technology;
- a U.S.-person-only environment;
- an export-control records system; or
- compliant with a customer's Technology Control Plan unless expressly reviewed and agreed in writing.

Marketing materials, sales communications, onboarding documentation, and support communications must remain consistent with these limitations.
...
- customer classification requirements;
- licensing requirements;
- U.S.-person personnel restrictions;
- identity and nationality controls;
...
- before onboarding a customer performing defense-related or export-controlled research;
- before accepting any Technology Control Plan requirement;
...
**Current export-control pilot scope:** ITAR-controlled technical data and restricted export-controlled information are prohibited.

**ITAR-controlled technical data permitted:** No.
...
**Review status:** Approved for the initial restricted export-control paid-pilot scope.
