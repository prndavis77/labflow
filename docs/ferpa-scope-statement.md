...
- applicable university privacy, information-security, records-management, and student-record policies.

## 2. FERPA Regulatory Boundary

FERPA protects the privacy of education records maintained by educational agencies and institutions that are subject to FERPA.

Education records may include records that:
...
- course grades;
- examination scores maintained as education records;
- academic standing;
- disciplinary records;
- student financial-aid records;
- institutional advising records;
- enrollment records;
- attendance records maintained as education records;
- official degree-progress records;
- student identification numbers linked to education records;
- registrar records;
- disability or accommodation records maintained as education records;
- personally identifiable information extracted from institutional student-information systems;
- identifiable student evaluations maintained as education records; and
- attachments containing official student education records or identifiable extracts from those records.

The presence of a student's name alone does not automatically make every record a FERPA education record.
...
- other permitted research-project information.
...
- non-regulated laboratory notebook entries;
- project collaboration;
- review workflows;
- ordinary research attachments; and
- administrative laboratory information.

Customers should use particular caution where laboratory records are also used to determine:
...
FERPA's concept of personally identifiable information may include more than a student's name.

Depending on the circumstances, identifying information may include:

- student name;
- student or institutional identification number;
- address;
- personal identifiers;
- indirect identifiers;
- combinations of information that can identify a student;
- information linked or linkable to a particular student; and
- other information defined as personally identifiable under applicable FERPA requirements.

Users must not assume that replacing a student's name with initials, a laboratory code, or another identifier automatically makes information non-identifiable.

## 7. De-Identified Student Information
...
FERPA may permit an educational institution to disclose education records to certain contractors or other outside parties under the school-official exception when the applicable requirements are satisfied.

Those requirements may include that the outside party:

- performs an institutional service or function for which the institution would otherwise use employees;
- is under the direct control of the educational agency or institution with respect to the use and maintenance of education records;
- uses personally identifiable information only for the purposes for which the disclosure was made;
- complies with applicable redisclosure restrictions; and
- satisfies the institution's criteria for school officials with legitimate educational interests.
...
- defined permitted purposes;
- institution-directed access;
- limits on use;
...
- contractual language reflecting the institution's FERPA responsibilities.

The initial paid-pilot documentation does not by itself establish such a FERPA arrangement.

## 10. Research and FERPA

FERPA does not prohibit research generally.

However, personally identifiable information from education records may not be disclosed or used merely because the recipient is conducting research.

FERPA includes specific exceptions for certain studies conducted for or on behalf of educational agencies or institutions.

Those exceptions may have requirements concerning:

- the purpose of the study;
- written agreements;
- permitted use of personally identifiable information;
- access restrictions;
- prevention of unauthorized identification;
...
- FERPA certified;
- FERPA approved;
- an institutional student-information system;
- a registrar system;
- an official academic-record system;
...
- school-official or other applicable FERPA exception analysis;
- institutional direct-control requirements;
- use and redisclosure restrictions;
- access-control review;
- retention and deletion requirements;
- security and incident-response review;
- subprocessor review;
...
**Current FERPA pilot scope:** Official FERPA-protected education records are prohibited.
...
**Student users permitted:** Yes, subject to the Pilot Data Policy and institutional requirements.

**Ordinary permitted laboratory/research workflow data:** Yes.

**Review status:** Approved for the initial restricted FERPA paid-pilot scope.
