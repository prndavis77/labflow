...
We may collect or process information such as:

- name;
- email address;
- organization or laboratory affiliation;
- department;
- assigned role;
- account status;
- account permissions;
...
- related laboratory workflow information.
...
- delivery metadata;
- timestamps; and
- temporary invitation, verification, or password-reset links.
...
This information is used primarily to operate, secure, troubleshoot, and maintain the service.
...
Audit records are used for security, troubleshooting, accountability, and service administration.
...
A university, laboratory administrator, supervisor, or other authorized customer representative may provide information necessary to establish or administer an account or organization.
...
- providing laboratory project-management functionality;
- storing and retrieving Customer Content;
- managing attachments;
- delivering transactional email;
- enabling collaboration among authorized users;
- enforcing organization and tenant isolation;
- maintaining audit records;
- preventing unauthorized access;
- detecting and investigating security issues;
- troubleshooting errors;
- maintaining service availability;
- backing up and recovering service data;
- responding to customer or user requests;
...
- uptime and operational monitoring.
...
- remember required application state;
...
- account and organization offboarding procedures; and
...
- obtain information concerning certain disclosures;
...
If the information is controlled by a university or other organizational customer, we may direct the requester to that organization or coordinate the request with it.
...
## 19. Account and Data Requests

Authorized organizational representatives may request:
...
When we make material changes, we will update the "Last updated" date and provide additional notice where required by applicable law or customer agreement.

Material changes will not be applied retroactively in a manner inconsistent with applicable law.
