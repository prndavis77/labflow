...
- invitations
- file attachments
- other information entered or uploaded by pilot users
...
### 2. Laboratory project-management information
...
### 3. Ordinary experimental planning and workflow information

Permitted examples include:

- experiment titles
- experimental objectives
- non-sensitive experimental notes
- workflow status
- experiment dates
- researcher assignments
- review comments
- approval or change-request history

### 4. Protocol and SOP information

Permitted examples include:

- ordinary laboratory protocols
- standard operating procedures
- instrument operating procedures
- sample-preparation procedures
- ordinary research methods that are not subject to the prohibited-data restrictions in this policy
- method versions
- review and approval information

Protocols must not contain prohibited regulated, classified, export-controlled, or highly sensitive information described below.
...
- availability status
- maintenance notes
- ordinary equipment-booking information
- booking purposes
- links between equipment and projects or experiments

### 6. Permitted research files

Permitted attachments may include:
...
- non-sensitive experimental worksheets
- instrument SOPs
...
Pilot users may store ordinary research information where disclosure would not create a significant privacy, regulatory, national-security, contractual, or intellectual-property risk.
...
- synthetic datasets
- public or publication-ready data
- routine laboratory observations
- non-confidential research notes

When there is uncertainty about whether a dataset is sensitive or regulated, it must not be uploaded until the laboratory confirms that its use is permitted.
...
- electronic PHI (ePHI)
- patient names or identifiers linked to health information
- medical-record numbers
- patient diagnoses
- patient laboratory results
- identifiable clinical specimens or sample records
...
### 3. Export-controlled technical data

Do not store information subject to:

- International Traffic in Arms Regulations (ITAR)
- Export Administration Regulations (EAR) restrictions requiring controlled access
- other United States export-control restrictions
...
Do not use the pilot as a regulated system of record for:

- FDA-regulated GxP records
- GLP records requiring validated computerized systems
...
- signed URLs intended to remain confidential

### 7. Highly sensitive personal information
...
- precise personal financial information
- personal medical information
- other sensitive identity documents

### 8. Highly confidential institutional or research information

The pilot should not be used for information whose unauthorized disclosure could create substantial institutional, commercial, national-security, or intellectual-property harm.

Ordinary unpublished research is not prohibited solely because it has not yet been published. This restriction applies where the information is subject to heightened institutional, contractual, legal, sponsor, export-control, or intellectual-property protections that require an approved restricted environment.

Examples may include:

- unreleased patent-enabling details where institutional policy requires restricted systems
- confidential third-party datasets subject to restrictive agreements
- trade secrets requiring specially approved storage
- embargoed sponsor information requiring dedicated security controls

The laboratory should consult its institutional research, information-security, or technology-transfer office if classification is uncertain.
...
- generic study-management tasks
- non-identifiable project milestones
- equipment bookings
- generic protocol workflow
- aggregate or appropriately de-identified research results

Participant identifiers, PHI, identifiable clinical data, consent forms containing personal information, and similar records are prohibited.
...
8. backup copies should be handled according to the applicable backup and retention procedures
9. any additional notification, investigation, preservation, or response obligations required by law, contract, or institutional policy remain applicable
...
Before pilot activation, an authorized representative of the customer should confirm that:
